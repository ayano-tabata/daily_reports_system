...
/**
 * Servlet implementation class ReportsUnapprovedIndexServlet
 */
@WebServlet("/reports/unapproved")
public class ReportsUnapprovedIndexServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportsUnapprovedIndexServlet() {
        super();
    }
